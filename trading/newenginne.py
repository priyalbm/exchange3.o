...
from notifications.firebase import send_bulk_notifications
# Add these imports at the top of the file
    ...
    def post(self, request):
        ...
        if bot_id:
            ...
            try:
                ...
                # Check wallet balance before starting to ensure sufficient funds
                try:
                    wallet_balance = run_async_with_cleanup(
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                if bot_id in RUNNING_BOTS:
                    ...
                    # Send notification about bot stop
                    try:
                        # Get the notification models
                        Notification = apps.get_model('notifications', 'Notification')
                        DeviceToken = apps.get_model('notifications', 'DeviceToken')
